                    ...
                    <div class="card dashboard-card">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <div class="col-xxl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body bg-main rounded-4">
                                        <h5 class="card-title"></h5>
                                        <div class="d-flex align-items-center">
                                            <div class="ps-3 card-alur">
                                                <h6>Daftar Akun</h6> <span class="small pt-2">Buat Akun PPDB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body  rounded-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="ps-3 card-alur">
                                                <h6>Daftar Akun</h6>
                                                <span class="small pt-2">Buat Akun PPDB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
